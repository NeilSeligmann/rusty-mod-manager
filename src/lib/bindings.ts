...
const ARGS_MAP = {"nexusmods":"{\"validate_user\":[]}","instances":"{\"create_empty_mod\":[\"name\"],\"run_executable\":[\"executable\"],\"unmount_vfs\":[],\"list_available_instances\":[],\"move_mods_by_indexes\":[\"indexes\",\"target_index\"],\"set_mod_active_version\":[\"mod_name\",\"mod_version\"],\"move_mod_by_index\":[\"mod_index\",\"target_index\"],\"delete_mod\":[\"mod_name\"],\"get_plugins\":[],\"select\":[\"path\"],\"delete_mod_version\":[\"mod_name\",\"mod_version\"],\"move_mod_by_name\":[\"mod_name\",\"target_index\"],\"create_simple\":[\"name\",\"paths\"],\"set_mod_enabled\":[\"mod_name\",\"enabled\"],\"stop_executable\":[\"executable\"],\"update_config\":[\"config\"],\"set_executables\":[\"executables\"],\"deselect\":[],\"mount_vfs\":[],\"open_mod_folder\":[\"mod_name\"],\"reload_mods\":[]}","downloads":"{\"download_urls\":[\"url\"],\"delete_downloads\":[\"filenames\"],\"install_mod_from_extracted\":[\"extracted_file\",\"install_mod\"],\"open_extracted_folder\":[\"extracted_file\"],\"resume_downloads\":[],\"list_extracted_path_flattened\":[\"extracted_file\"],\"list_file_structure_relatively\":[\"extracted_file\"],\"read_extracted_file\":[\"extracted_file\",\"paths\"],\"open_download_in_filemanager\":[\"filename\"],\"on_downloads_update\":[\"downloads\"],\"install_file\":[\"filename\"],\"extract_file\":[\"filename\"]}","":"{\"on_state_changed\":[\"new_state\"],\"update_application_config\":[\"config\"],\"update_frontend_config\":[\"config\"],\"open_folder\":[\"path\"],\"show_file_in_filemanager\":[\"path\"],\"get_config_path\":[],\"get_state\":[\"with_downloads\"]}"}
